...
* If we assign unit 1 to treatment we will estimate $\hat\tau = 1-1 = 0$, otherwise we will estimate $\hat\tau = 2-0 = 2$. So we will be right on average but have **high variance**.
